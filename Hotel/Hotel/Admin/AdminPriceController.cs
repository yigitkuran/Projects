...
namespace Hotel.Admin
{
    public class AdminPriceController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PriceId,RoomId,Charge,Term,Month,Day,Currency,Deposit,Discount")] Price price)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriceId,RoomId,Charge,Term,Month,Day,Currency,Deposit,Discount")] Price price)
        {
            if (ModelState.IsValid)
            {
